                ...
                return <div className="mx-auto w-full max-w-[550px] bg-white" key={index}>
                    <div className="-mx-3 flex flex-wrap">
                        <div className="w-full sm:w-2/3">
                            <div className="mb-5">
                                {/* <label for="companyName" className="mb-3 block text-base font-medium text-[#07074D]">
                                Company Name
                                </label> */}
                        ...
                        <div className="w-full pl-2 sm:w-1/3">
                            <div className="mb-5">
                                {/* <label for="postName" className="mb-3 block text-base font-medium text-[#07074D]">
                                Position
                                </label> */}
                    ...
                    <div className="-mx-3 flex flex-wrap">
                        <div className="w-full sm:w-1/2">
                            <div className="mb-5">
                                {/* <label for="startDate" className="mb-3 block text-base font-medium text-[#07074D]">
                                    Start Date
                                </label> */}
